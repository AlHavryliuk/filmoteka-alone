export const refs = {
  ...
  libaryGalleryEl: document.querySelector('.gallery-libary'),
  galleryCardLibEl: document.querySelector('.gallery__card-libary'),
  libaryWatchedBtn: document.querySelector('[data-libary-type="watched"]'),
